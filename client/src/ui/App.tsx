...
const App: React.FC = () => {
  ...
  const onChoice = (choice: string) => {
    ...
    if (currentStepId === 3) {
      ...
      addBot([rec, "Als Nächstes: Wie viele Prints möchtest du insgesamt?"].join("\n\n"));
...
// Schritt 4 – Druckformat
  ...
  <div className="brand">
    <img
      src={import.meta.env.BASE_URL + "fobi-logo.png"}
      alt="FOBI Fotobox Logo"
  ...
  <button
    ...
    onClick={() => {
      // Reset selections & messages but keep consent
      setSelections({});
      setCurrentStepId(1);
      setMessages([
        { from: "assistant", text: "Hi! Ich begleite dich Schritt für Schritt zur passenden Fotobox. Möchtest du die Fotobox 🖥️ digital nutzen oder 📸 Digital & Print?" }
      ]);
    }}
