  ...
  if (consent === "unknown") {
    return (
      <ConsentGate
        ...
        title={(K?.brand ? `${K.brand} – Datenschutzhinweis` : "Datenschutzhinweis")}
        noticeText={
          K?.privacy_notice ??
          "Hinweis: Dieser Chat dient ausschließlich der Beratung und Preisfindung. Bitte keine personenbezogenen Daten eingeben."
        }
      />
    );
  }
